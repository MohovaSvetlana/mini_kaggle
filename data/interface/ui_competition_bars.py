...
class CompetitionBars(PagesBar):
    def __init__(self):
        ...
        self.send_solution_btn = QPushButton("Отослать решение")
        self.send_solution_btn.clicked.connect(lambda: self.controller.change_page(Pages.send_solution_page))
        self.all_solutions_btn = QPushButton("Все решения")
        self.all_solutions_btn.clicked.connect(lambda: self.controller.change_page(Pages.all_solutions_page))
        ...
        self.test_leaderboard_btn.clicked.connect(lambda: self.controller.change_page(Pages.leaderboard_page))
